...
def main():
    # Set up Google Sheets only once
    ...
    while True:
        # Get the top 100 tickers
        tickers = get_sp500_stocks()[:100]
        total_stocks = len(tickers)
        
        # Clear the sheet and add headers for fresh data
        sheet.clear()
        ...
        print("\nCompleted analysis cycle. Waiting 10 minutes before next update.")
